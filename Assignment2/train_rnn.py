...
def main(args):
    ...
    if args.tensorboard_logging:
        # print(args.logdir, experiment_name_rnn(args,ts))
    ...
    for epoch in range(args.epochs):
        ...
        for split in splits:
            ...
            for iteration, batch in enumerate(data_loader):
                ...
                # loss calculation
                NLL_loss = loss_fn(logp, batch['target'].long(), batch['length'])
                ...
                # bookkeepeing
                tracker['Loss'] = torch.cat((tracker['Loss'], torch.tensor([loss.data]).cuda()))
